...
public class FileDao {
	...
	public void add(File file) throws SQLException {
		...
		if(!resultSet.next()) {
			...
			throw new SQLException("nessuna cartella trovata");
		}
	...
	public File getFile(String id, String username) throws NumberFormatException, SQLException {
        ...
        if (rs.next()) {
            ...
            sql = "SELECT holder, name, creation_date FROM foldersystem WHERE id = ?";
